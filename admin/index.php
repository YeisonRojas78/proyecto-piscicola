...
$cantEstanques = $estanques->TotalEstanques();

$ventas = new misVentas();
$cantVentas = $ventas->TotalVentas();

$peces = new misPeces();
$cantPeces = $peces->TotalPeces();

$crecimientoPeces = new misCrecimientos();
$cantCrecimientoPeces = $crecimientoPeces->TotalCrecimientoPeces();

$alimentaciones = new misAlimentaciones();
$cantAlimentacionPeces = $alimentaciones->TotalAlimentacionPeces();

$sensores = new misSensores();
$cantSensores = $sensores->TotalSensores();

$usuarios = new misUsuarios();
$cantUsuarios = $usuarios->totalUsuarios();

// NUEVOS: Parámetros agua
$parametrosAgua = new misParametros();
$cantParametros = $parametrosAgua->TotalParametrosAgua();
$promedios = $parametrosAgua->PromediosParametros();
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <h2 class="text-left">USUARIOS</h2>
                        <!-- duplicado de informacion  -->
                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $cantUsuarios ?></div>
                                                </div>
                                                <div class="col-auto">
