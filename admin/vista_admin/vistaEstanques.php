...
$estanques = $misEstanque->estanquesAdmin();
?>
        ...
        <div class="table-responsive">
            <table id="tablaEstanquesData" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>Cantidad Alimentaciones</th>
                    <th>Cantidad Crecimientos</th>
                    <th>Editar</th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($estanques as $estanque): ?>
                    <tr class="text-center">
                        ...
                        <td><?= $estanque["nombre_propietario"] ?></td>
                        <td><?= $estanque["nombre_estanque"] ?></td>
                        <td><?= $estanque["ubicacion"] ?></td>
                        <td><?= $estanque["capacidad"] ?> Lt</td>
                        <td><?= $estanque["estado"] ?></td>
                        <td><a href="../admin/peces.php" class="text-decoration-underline text-dark"><?= $estanque["cantidad_peces"] ?> </a></td>
                        <td><a href="../admin/alertas.php" class="text-decoration-underline text-dark"><?= $estanque["cantidad_alertas"] ?></a></td>
                        <td><a href="../admin/alimentacion.php" class="text-decoration-underline text-dark"><?= $estanque["cantidad_alimentaciones"] ?></a></td>
                        <td><a href="../admin/crecimientoPeces.php" class="text-decoration-underline text-dark"><?= $estanque["cantidad_crecimientos"] ?></a></td>
                        <td>
                            <button class="btn btn-warning btn-sm btnEditarEstanqueAdmin"
                                    data-id_estanque="<?= $estanque["id_estanque"] ?>"
                                    ...
                                    data-usuarios_id="<?= $estanque["id_propietario"] ?>"
                                    data-bs-toggle="modal"
                                    data-bs-target="#modalEditarEstanqueAdmin">
