...
if (isset($_SESSION['id_usuario'])) {
    ...
    $peces = $misPeces->PecesPropietarios($idUsuario);
} else {
                    ...
                    foreach ($peces as $pez) {
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <td><?php echo $pez["especie"]; ?></td>
                                <td><?php echo $pez["cantidad"]; ?></td>
                                <td><?php echo $pez["peso_promedio"]; ?> Kg</td>
                                <td><?php echo $pez["fecha_ingreso"]; ?></td>
                                <td><?php echo $pez["estado"]; ?></td>
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalEditarPezPropietario"
                                            data-id="<?php echo $pez['id_peces']; ?>" onclick= "llenarEditarPecesPropietario('<?php echo$datosAp;?>')"> <i class="bi bi-pencil"></i>
                                    </button>
                                </td>
                            </tr>
                    <?php
