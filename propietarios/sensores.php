...
require_once '../servicios/datos_sensores.php';
...
<body id="page-top" class="cuerpo">
    ...
    <div class="container mt-4">
        ...
        <div id="tablaSensores"></div>
    </div>

    <!-- Modales -->
    <?php include_once 'modales/modalSensores.php'; ?>

    <!-- Librerías JS -->
    <?php include_once "librerias-js.php"; ?>
    <script src="../controladores/controladorSensores.js"></script>
    <script>
        $(document).ready(function () {
            $('#overlay').show();
            $('#tablaSensores').load('vista_propietarios/vistaSensores.php', function () {
