...
imperdiet orci pretium vel. Donec vehicula tellus nisl, nec commodo diam posuere eu.',
   ...
   'Donec',
   'fringilla congue felis, ornare',
   'tempus velit congue at.',
   ...
   'velit odio ultricies quam',
   'ut accumsan massa enim a tortor',
...
$table = new easyTable($pdf, '{20, 30, 45, 45, 30}', 'width:170; border-color:#ffff00; font-size:10; border:1; paddingY:2;');
 ...
 $table->easyCell("Header 1", 'rowspan:2,4');
 $table->easyCell("Header 2", 'colspan:3');
 $table->easyCell("Header 3",'rowspan:2');
 $table->printRow();

 $table->rowStyle('align:{RCC}; bgcolor:#00ace6;font-style:B');
 $table->easyCell("Header 4",'colspan:3');
